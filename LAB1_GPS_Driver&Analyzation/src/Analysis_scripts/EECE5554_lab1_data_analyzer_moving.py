...
for i in range(618):
    if i > 214 and i <= 549:
        ...
        raw_data[i,1] += Long_1
        raw_data[i,2] += Alt_1
        raw_data[i,3] += UTM_E_1
        raw_data[i,4] += UTM_N_1
    elif i > 549:
        raw_data[i,0] += Lat_1 + Lat_2
        raw_data[i,1] += Long_1 + Long_2
        raw_data[i,2] += Alt_1 + Alt_2
        raw_data[i,3] += UTM_E_1 + UTM_E_2
        raw_data[i,4] += UTM_N_1 + UTM_N_2
