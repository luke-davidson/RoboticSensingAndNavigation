...
"""
This script will read serial data from an IMU device reporting to port specified in usb_port_num and publish the data to the topic 'imu_data'.
...
import serial
import numpy as np
from lab4_package.msg import IMU_msg
from std_msgs.msg import Header

usb_port_num = '0'
port = '/dev/ttyUSB' + usb_port_num
...
def imu_data_recorder():
    ...
    rospy.logdebug('Reading IMU data at Baud rate 115200')
    rate = rospy.Rate(40)
